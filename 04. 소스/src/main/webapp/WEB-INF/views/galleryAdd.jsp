		...
		<table class="table table-sm table-borderless border">
			...
			<tbody>
				...
				<tr>
					...
					<td class="cursor-defualt"><input type="text" id="contentName" name="contentName" class="form-control"></td>
				</tr>
				...
				<tr class="table-secondary">
					<td class="p-3 cursor-defualt" colspan="2">
						썸네일로 사용할 파일명 입력 : <input type="text" name="thumbnail" /><br/>					
						<span class="text-danger cursor-defualt">(*업로드된 이미지 우클릭 해서 파일명 확인)</span>
					</td>
				</tr>
			</tbody>
		</table>
