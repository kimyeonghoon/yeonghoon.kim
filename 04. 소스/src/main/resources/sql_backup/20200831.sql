...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='약력에 대한 정보를 담는 테이블';
...
INSERT INTO `member` (`member_no`, `member_email`, `member_password`, `member_name`, `member_address`, `member_address_detail`, `member_gender`, `member_tel`, `member_birthday`, `member_delete_yn`) VALUES
	...
	(5, 'jdld@ckd.com', '1234', 'dasda', NULL, '111', 0, '04422321321', NULL, 1),
	(6, 'jdld@ckd.com', '1234', 'dasda', NULL, '111', 0, '04422321321', NULL, 1),
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='기술에 대한 정보를 담는 테이블';

-- 테이블 데이터 yeonghoon.kim.tech:~0 rows (대략적) 내보내기
...
CREATE TABLE IF NOT EXISTS `tech_category` (
  ...
  `tech_category_delete_yn` int(11) unsigned NOT NULL,
  PRIMARY KEY (`tech_category_no`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='기술분류에 대한 정보를 담는 테이블';

-- 테이블 데이터 yeonghoon.kim.tech_category:~0 rows (대략적) 내보내기
