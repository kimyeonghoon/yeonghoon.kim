...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COMMENT='경력에 대한 정보를 담는 테이블';
...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COMMENT='회사에 대한 정보를 담는 테이블';
...
REPLACE INTO `company` (`company_no`, `member_no`, `company_name`, `company_startdate`, `company_enddate`, `company_upload_path`, `company_delete_yn`) VALUES
	...
	(5, 1, '기프트엠', '2019-01-31', '2019-12-13', NULL, 1),
	(6, 1, '스마일서브', '2015-07-11', '2018-11-05', NULL, 1),
...
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8mb4 COMMENT='학력에 대한 정보를 담는 테이블';
...
REPLACE INTO `education` (`education_no`, `member_no`, `education_name`, `education_department`, `education_status`, `education_startdate`, `education_enddate`, `education_etc`, `education_upload_path`, `education_delete_yn`) VALUES
	(1, 1, '동아대학교', '사학과', 1, '2006-03-01', '2013-02-01', '학점 : 3.0 / 4.5', NULL, 1),
	(2, 1, '오천고등학교', NULL, 1, '2003-03-01', '2006-02-01', '인문계열', NULL, 1),
