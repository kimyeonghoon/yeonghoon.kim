...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COMMENT='교육에 대한 정보를 담는 테이블';
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COMMENT='자격증에 대한 정보를 담는 테이블';
...
REPLACE INTO `certificate` (`certificate_no`, `member_no`, `certificate_name`, `certificate_organization`, `certificate_pass_yn`, `certificate_issue_date`, `certificate_upload_path`, `certificate_delete_yn`) VALUES
	...
	(6, 1, '정보처리기사', '한국산업인력공단', 1, '2015-05-08', '1', 1),
...
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COMMENT='회사에 대한 정보를 담는 테이블';

-- 테이블 데이터 yeonghoon.kim.company:~12 rows (대략적) 내보내기
...
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COMMENT='회원에 대한 정보를 담는 테이블';
