...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COMMENT='교육에 대한 정보를 담는 테이블';

-- 테이블 데이터 yeonghoon.kim.academy:~2 rows (대략적) 내보내기
/*!40000 ALTER TABLE `academy` DISABLE KEYS */;
REPLACE INTO `academy` (`academy_no`, `member_no`, `academy_course`, `academy_content`, `academy_academy`, `academy_startdate`, `academy_enddate`, `academy_upload_path`, `academy_delete_yn`) VALUES
	(1, 1, '오라클기반 정보시스템 운영', '1. Windows Server/Linux Server 실무 및 보안\r\n2. 네트워크 인프라 솔루션(CCNA, CCNP)\r\n3. 가상사설망 VPN\r\n4. 오라클 데이터베이스\r\n5. 실전 클라우드 가상화 구축 기술\r\n6. 실무 Project', '아이티윌 부산교육센터', '2014-12-22', '2015-06-09', NULL, 1),
	(2, 1, '자바기반 스마트 웹&콘텐츠 개발자 양성과정', '1. Web Front-End (UI) : html, CSS, JavaScript, jQuery, JSP\r\n2. DataBase : Oracle DB\r\n3. Web Back-End : JAVA, SpringFramework, MyBatis\r\n4. Team Project ', '구디아카데미', '2020-02-17', '2020-08-05', NULL, 1);
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COMMENT='경력에 대한 정보를 담는 테이블';

-- 테이블 데이터 yeonghoon.kim.career:~7 rows (대략적) 내보내기
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COMMENT='자격증에 대한 정보를 담는 테이블';

-- 테이블 데이터 yeonghoon.kim.certificate:~3 rows (대략적) 내보내기
...
REPLACE INTO `certificate` (`certificate_no`, `member_no`, `certificate_name`, `certificate_organization`, `certificate_pass_yn`, `certificate_issue_date`, `certificate_upload_path`, `certificate_delete_yn`) VALUES
	(1, 1, '컴퓨터활용능력 2급', '대한상공회의소 ', 1, '2012-08-17', NULL, 1),
	(3, 1, '사무자동화산업기사', '한국산업인력공단 ', 1, '2012-08-17', NULL, 1),
	(4, 1, 'PC정비사1급', '한국정보통신자격협회 ', 1, '2013-11-26', NULL, 1),
	(5, 1, '정보처리기사', '한국산업인력공단', 1, '2015-05-08', NULL, 1);
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COMMENT='회사에 대한 정보를 담는 테이블';

-- 테이블 데이터 yeonghoon.kim.company:~9 rows (대략적) 내보내기
...
REPLACE INTO `company` (`company_no`, `member_no`, `company_name`, `company_startdate`, `company_enddate`, `company_upload_path`, `company_delete_yn`) VALUES
	...
	(11, 1, '스마일서브', '2015-07-11', '2018-11-05', NULL, 1),
	(12, 1, '기프트엠', '2019-01-31', '2019-12-13', NULL, 1);
...
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8mb4 COMMENT='학력에 대한 정보를 담는 테이블';
...
REPLACE INTO `education` (`education_no`, `member_no`, `education_name`, `education_department`, `education_status`, `education_startdate`, `education_enddate`, `education_etc`, `education_upload_path`, `education_delete_yn`) VALUES
	...
	(2, 1, '동아대학교', '사학과', 1, '2006-03-01', '2013-02-19', '학점 : 3.0 / 4.5', NULL, 1),
